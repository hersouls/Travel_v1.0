    ...
    return (
      <div className="mb-4 rounded-lg border border-red-200 bg-red-50 p-4">
        <div className="flex items-center">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-red-800">{context} 오류</h3>
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6 p-6">
      <div className="rounded-lg bg-white p-6 shadow">
        <h2 className="mb-4 text-2xl font-bold">에러 처리 개선 예제</h2>

        {/* 연결 상태 */}
        <div className="mb-6">
          <h3 className="mb-2 text-lg font-semibold">연결 상태</h3>
        ...
        {/* 인증 상태 */}
        <div className="mb-6">
          <h3 className="mb-2 text-lg font-semibold">인증 상태</h3>
          {authLoading ? (
                  ...
                  {travelPlans.length > 0 && (
                    <div className="space-y-2">
                      {travelPlans.slice(0, 3).map((plan) => (
                        <div key={plan.id} className="rounded bg-gray-50 p-3">
