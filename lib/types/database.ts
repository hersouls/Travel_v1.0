...
export type InsertTravelPlan =
  Database['public']['Tables']['travel_plans']['Insert'];
export type UpdateTravelPlan =
  Database['public']['Tables']['travel_plans']['Update'];

export type TravelDay = Database['public']['Tables']['travel_days']['Row'];
export type InsertTravelDay =
  Database['public']['Tables']['travel_days']['Insert'];
export type UpdateTravelDay =
  Database['public']['Tables']['travel_days']['Update'];
...
export type InsertPaymentHistory =
  Database['public']['Tables']['payment_history']['Insert'];
export type UpdatePaymentHistory =
  Database['public']['Tables']['payment_history']['Update'];
...
export type InsertCollaborator =
  Database['public']['Tables']['collaborators']['Insert'];
export type UpdateCollaborator =
  Database['public']['Tables']['collaborators']['Update'];
...
export interface TravelPlanWithDetails
  extends Omit<TravelPlan, 'collaborators'> {
